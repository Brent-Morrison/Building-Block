...
# 
# ui <- fluidPage(
#   h4("Sparkline example"),
#   sparklineOutput("sp")
# )
# 
# server <- function(input, output, session) {
#   output$sp <- renderSparkline({
#     sparkline(
#       c(10, 12, 9, 14, 18, 16),
#       type = "line",
#       width = 100,
...
ui <- fluidPage(
  ...
  column(
    ...
    br(),
    conditionalPanel(condition = "input.toggleInputSelect=='dragDrop'",  plotlyOutput("speed_p", height = "250px")),
    conditionalPanel(condition = "input.toggleInputSelect=='handTyped'", matrixInput("rateInputs_mi", value = rateInputs_m, class = "numeric", row = list(names = FALSE)))
  ),
...
# }
# 
# stones <- read.csv('https://raw.githubusercontent.com/hadley/monthApp/refs/heads/master/birthstones.csv')
